...
-Step 5: Flash ISO image onto a usb and boot into it using the BIOS or use a VM and put the ISO image into a machine with BIOS only
--Note that using UEFI with Null OS will absolutely be a terrible idea because most UEFI don't have 16-bit real mode support, stick to BIOS always for Null OS. 
